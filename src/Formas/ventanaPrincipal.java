...
public class ventanaPrincipal extends javax.swing.JFrame {
     ...
     */
    public ventanaPrincipal(String usuario, String ico, Connection c) {
        initComponents();
    ...
    public void agregarArticulo(String codigo, String articulo, String cantidad, String pu, String importe) {
        DefaultTableModel modelo = (DefaultTableModel) tablaVenta.getModel();
        modelo.addRow(new Object[]{codigo, articulo, cantidad, pu, importe});
        sumaVenta();
    }
    ...
    public void cambiarPrecios(String estado) {
        ...
        if (estado.equals("S")) {
            for (int i = 0; i < modelo.getRowCount(); i++) {
                pu = Float.parseFloat(modelo.getValueAt(i, 3) + "") / 1.16;
                modelo.setValueAt(df.format(pu), i, 3);
                total = Float.parseFloat(modelo.getValueAt(i, 4) + "") / 1.16;
                modelo.setValueAt(df.format(total), i, 4);
                estadoImpuesto = "N";
            }
        } else {
            for (int i = 0; i < modelo.getRowCount(); i++) {
    ...
    private void tablaOrdenesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaOrdenesMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ventanaFacturas vf = new ventanaFacturas(codigo, cliente, cn);
            vf.setVisible(true);
        }
